...
<Meta
  ...
  argTypes={{
    ...
    language: {
      ...
      table: {},
      options: ['jsx', 'typescript', 'css', 'scss', 'json', 'jsx', 'tsx', 'xml', 'markdown'],
      control: { type: 'select' }
    },
    theme: {
      name: 'theme',
...
By default we support `javascript`, `jsx`, `typescript`, `tsx`, `css`, or any `xml` based language. If you need other languages you can import them from `highlight.js` like `import 'highlight.js/lib/languages/javascript';`.
