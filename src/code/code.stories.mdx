...
<Codesandbox
  ...
  code={`
    <div pa-code editable="true" [language]={'javascript'} [theme]="'a11y-dark'" [code]="'const age = 1;'"></div>`}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.6.0' }}
  code={`
    <Code editable language={'javascript'} theme="a11y-dark" code="const age = 1;"></Code>`}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.6.0' }}
  code={`
    <Code :editable="true" :language="'javascript'" theme="a11y-dark" code="const age = 1;"></Code>`}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.6.0' }}
  code={`<pa-code editable="true" language="'javascript'" theme="a11y-dark" code="const age = 1;"></pa-code>`}
/>
