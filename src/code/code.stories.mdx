...
<Meta
  ...
  argTypes={{
    ...
    language: {
      ...
      options: ['javascript', 'typescript', 'css', 'scss', 'json'],
      control: { type: 'select' }
    },
    theme: {
      name: 'theme',
...
<Codesandbox
  ...
  code={`
     <div pa-code editable="true" language="javascript" theme="a11y-dark">const name = 'component';</div>
  `}
/>
...
<Codesandbox
  ...
  dependencies={{ 'highlight.js': '11.5.1' }}
  code={`
     <Code editable  language="javascript" theme="a11y-dark">const name = 'component';</Code>
  `}
/>
