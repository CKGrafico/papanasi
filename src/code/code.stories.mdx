...
```js
import { Code } from '@papanasi/angular';
...
```html
<div className="app">
  <div pa-code editable="true">const name = 'component';</div>
</div>
```
...
```js
import { Code } from '@papanasi/react';
import '@papanasi/react/dist/papanasi.css';
export default function App() {
  return <Code editable>const name = 'component';</Code>;
}
```
